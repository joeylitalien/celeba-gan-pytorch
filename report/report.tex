...
\begin{figure}[ht]
  ...
  \begin{subfigure}{\textwidth}
    \centering
    \includegraphics[scale=0.4]{imgs/gan_epoch50}
    \caption{Vanilla GAN}
  \end{subfigure}
  ...
  \begin{subfigure}{\textwidth}
    \centering
    \includegraphics[scale=0.4]{imgs/wgan_epoch50}
    \caption{WGAN}
  \end{subfigure}
  \caption{100 generated images using both models trained for 50 epochs. All images look more or less plausible, with no mode collapse.}
\end{figure}
...
\begin{figure}[ht]
  ...
  \begin{subfigure}{\textwidth}
    \centering
    \includegraphics[scale=0.4]{imgs/lsgan_epoch44}
  ...
  \begin{subfigure}{\textwidth}
    \centering
    \includegraphics[scale=0.4]{imgs/lsgan_epoch50}
